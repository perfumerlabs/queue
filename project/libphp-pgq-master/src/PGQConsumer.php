...
abstract class PGQConsumer extends SystemDaemon
{
    ...
    public function process()
    {
        ...
        while (! $sleep && ! $this->killed) {
            ...
            switch ($batch_id) {
                ...
                case True:
                    $this->log->verbose("pgq\PGQConsumer.process: \$this->process_batch(%d).", $batch_id);
    ...
    public function process_batch($batch_id)
    {
        ...
        foreach ($events as $event) {
            ...
            if ($this->preprocess_event($event) === PGQ_ABORT_BATCH) {
                ...
                $this->log->verbose("pgq\PGQConsumer.process_batch processed event %d of batch %d, tag %d", $event->id, $batch_id, $tag);
    ...
    public function get_batch_events($batch_id)
    {
